            ...
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="@4xl:gap-12 @4xl:grid-cols-3 relative grid grid-cols-2 gap-6 lg:mt-16">
                    <div className="space-y-1.5">
                        ...
                        <p className="text-muted-foreground line-clamp-2 text-sm">BlindBet is a fast and efficient AI-powered code editor that can help you write code faster and more efficiently.</p>
                    </div>
                    <div className="space-y-1.5">

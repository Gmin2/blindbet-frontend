...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
    ...
    return {
        ...
        alternates: {
            canonical: `/grid-1/blog-one/${slug}`,
        },
    }
}
        ...
        <div className="relative mx-auto max-w-6xl px-6 lg:px-12">
            <div className="grid max-lg:gap-4 lg:grid-cols-[1fr_auto_1fr]">
                <Breadcrumb>
                    <BreadcrumbList>
                        <BreadcrumbItem>
                            <BreadcrumbLink href="/grid-1/blog-one">Blog</BreadcrumbLink>
                        </BreadcrumbItem>
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbLink href={`/grid-1/blog-one/category/${post.category.slug}`}>{post.category.title}</BreadcrumbLink>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>

...
export const DocumentIllustation = ({ className }: { className?: string }) => {
    return (
        <div className={cn('border-zinc-200 bg-white relative z-10 h-fit w-16 space-y-2 rounded-md border p-2 shadow-md shadow-black/5 [--color-border:color-mix(in_oklab,var(--color-foreground)15%,transparent)]', className)}>

            ...
            <div className="mx-auto max-w-5xl space-y-16 px-6">
                <div className="grid gap-12 md:grid-cols-5">
                    <div className="space-y-6 md:col-span-2 md:space-y-12">
                        ...
                        <p className="text-muted-foreground text-balance text-sm">BlindBet is a platform for building AI-powered applications.</p>
                    </div>
                    ...
                    <div className="col-span-3 grid gap-6 sm:grid-cols-3">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-wrap gap-3 text-sm">
                                ...
                                <Link
                                    href="https://github.com/Gmin2/blindbet"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    aria-label="GitHub"
                                    className="text-muted-foreground hover:text-primary block">
                ...
                <div className="flex flex-wrap justify-between gap-4">
                    <span className="text-muted-foreground text-sm">© {new Date().getFullYear()} BlindBet, All rights reserved </span>

...
import { Menu, X, ShieldCheck, Lock, EyeOff, Network, Zap, Globe, Coins, Landmark, Trophy, Star, HelpCircle, BookOpen, Notebook, Smartphone } from 'lucide-react'
...
const features: FeatureLink[] = [
    {
        href: '/#encrypted-liquidity',
        name: 'Encrypted Liquidity',
        description: 'Trade against hidden pools',
        icon: <Lock className="stroke-foreground fill-blue-500/15" />,
    },
    {
        href: '/#private-positions',
        name: 'Private Positions',
        description: 'Your bets remain confidential',
        icon: <EyeOff className="stroke-foreground fill-indigo-500/15" />,
    },
    {
...
const moreFeatures: FeatureLink[] = [
    {
        ...
        description: 'Unbiased market resolution',
        icon: <Network className="stroke-foreground fill-yellow-500/15" />,
    },
    {
        href: '/#fees',
        name: 'Low Fees',
        description: 'Optimized for high frequency',
        icon: <Zap className="stroke-foreground fill-orange-500/15" />,
    },
    {
        href: '/#cross-chain',
        name: 'Cross-Chain',
        description: 'Bet from any chain',
        icon: <Globe className="stroke-foreground fill-teal-500/15" />,
    },
]
                    ...
                    <div className="relative flex flex-wrap items-center justify-between lg:py-3">
                        ...
                        <div className="flex items-center justify-between gap-8 max-lg:h-14 max-lg:w-full max-lg:border-b">
                            <Link
                                href="/"
                                aria-label="home">
                                <span className="text-2xl font-bold tracking-tight">BlindBet</span>
                            </Link>
                    ...
                    <NavigationMenuContent className="mt-4.5 origin-top pb-14 pt-5 shadow-none ring-0">
                        <div className="min-w-5xl divide-foreground/10 grid w-full grid-cols-4 gap-4 divide-x pr-12">
                            <div className="row-span-2 -mr-2 grid grid-rows-subgrid gap-1 pr-2">
                                <span className="text-muted-foreground ml-2 text-xs">Platform</span>

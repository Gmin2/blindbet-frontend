    ...
    return (
        <>
            <div className="max-lg:hidden">
                ...
                `}</style>
                <div className="relative [--color-border-illustration:--alpha(var(--color-zinc-950)/20%)] [--color-border:--alpha(var(--color-zinc-950)/20%)]">
                    <div className="mask-t-from-65% mask-t-to-85% absolute inset-0">
                        <img
                            ...
                            alt="blindbet hero section background"
...
const TopMarketCard = () => {
    return (
        <div className="ring-foreground/15 bg-background relative z-10 flex aspect-video w-full flex-col overflow-hidden rounded-2xl border border-transparent shadow-2xl shadow-sky-950/15 ring-1">
            <div className="flex flex-col h-full p-5">
                <div className="flex items-start justify-between">
                    <div className="space-y-1">
                        ...
                        <div className="text-xl font-bold tracking-tight">Trump 2024</div>
                    </div>
                    <div className="text-right">
                        <div className="text-2xl font-bold tracking-tight">62%</div>
                        <div className="text-xs font-medium text-emerald-500">+4.2%</div>
                    </div>
                </div>
                <div className="flex-1 w-full mt-4 relative">
                    <svg
                        ...
                        />
                        <path
                            d="M0 30 Q 20 35 40 20 T 100 5 V 40 H 0 Z"
...
const LiveActivity = () => (
    <div className="flex h-full flex-col p-4">
        ...
        <div className="space-y-2.5">
            {[
                { user: '0x8a...2b', action: 'Bought Yes', amount: '$5,000' },
                { user: '0x4f...9c', action: 'Bought No', amount: '$1,200' },
                { user: '0x1d...ea', action: 'Bought Yes', amount: '$850' },
            ].map((item, i) => (
                <div
                    key={i}
                    className="flex items-center justify-between text-xs">
                    <div className="flex items-center gap-2">
                        <div className="size-6 rounded-full bg-muted flex items-center justify-center text-[10px] font-mono">
                            {item.user.slice(2, 4)}
                        </div>

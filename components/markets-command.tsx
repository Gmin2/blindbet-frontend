    ...
    return (
        <>
            <Button
                ...
                aria-label="Search markets and categories"
            ...
            <CommandDialog
                ...
                <CommandInput placeholder="Search markets or categories..." />
                    ...
                    <CommandGroup heading="Categories">
                        {categories.map((category) => (
                            <CommandItem
                                key={category.slug}
                                onSelect={() => {
                                    // Navigate to the markets page with the category query param
                                    router.push(`/markets?category=${category.slug}`)
                                    setOpen(false)
                                }}>

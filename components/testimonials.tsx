...
const testimonialsData = [
    {
        ...
        text: 'The component library from BlindBet has been a game-changer for our development team. We can quickly build consistent interfaces across our payment platform with minimal effort. The documentation is excellent and the customization options are exactly what we needed.',
    ...
    },
    {
        ...
        text: 'Implementing BlindBet components helped us create a more engaging streaming interface. The responsive design system works flawlessly across devices, and we were able to maintain our brand identity while leveraging their robust component architecture.',
    ...
    },
    {
        ...
        text: 'We needed a solution that could handle our complex UI requirements while maintaining performance. BlindBet delivered exactly that - their component system integrated seamlessly with our existing architecture and helped us launch new features in record time.',
